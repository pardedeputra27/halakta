...
<head>
    ...
    <!-- Favicon
    ================================================== -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/mypage/img/apple-touch-icon.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/mypage/img/favicon.png') }}">
    <!-- Stylesheets
    ================================================== -->
    <!-- Bootstrap core CSS -->
    <link href="{{ asset('assets/mypage/css/bootstrap.min.css') }}" rel="stylesheet">
    <!-- Custom styles for this template -->
    <link href="{{ asset('assets/mypage/css/style.css') }}" rel="stylesheet">
    <link href="{{ asset('assets/mypage/css/responsive.css') }}" rel="stylesheet">
...
<body>
        ...
        <nav id="primary-navigation" class="site-navigation">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <a href="#hero" class="site-logo"><img src="{{ asset('assets/mypage/img/logo.png') }}"
                            alt="logo"></a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <img src="{{ asset('assets/mypage/img/alex-vidal.png') }}" alt="alex-vidal">
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <h2>About</h2>
                        <img src="{{ asset('assets/mypage/img/lines.svg') }}" class="img-lines" alt="lines">
                        <p>Hello! I'm Alex, a full stuck developer, a Ruby enthusiast, and a guy slighty obsessed for
                            code quality. Also I'm a co-founder of pykod.com. I’m currently available for freelance
                            work. If you have a project that you want to get started or think you need my help with
                            something, then get in touch.</p>
                        <a href="http://www.grad.illinois.edu/sites/default/files/pdfs/cvsamples.pdf"
                            class="btn btn-fill" target="_blank" download>Download my cv</a>
                    </div>
                </div>
            </div>
        ...
        <section id="service" class="site-section section-services overlay text-center">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="service">
                            <img src="{{asset('assets/mypage/img/front-end.svg')}}" alt="Front End Developer">
                            <h4>Front-end</h4>
                    ...
                    <div class="col-sm-4">
                        <div class="service">
                            <img src="{{ asset('assets/mypage/img/back-end.svg') }}" alt="Back End Developer">
                            <h4>Back-end</h4>
                            <p>Utilising php frameworks such as Zend or creating bespoke code, I've written services
                                supporting thousands of users, including REST APIs, e-learning applications and more.
                            </p>
                        </div><!-- /.service -->
                    </div>
                    <div class="col-sm-4">
                        <div class="service">
                            <img src="{{asset('assets/mypage/img/consultancy.svg')}}" alt="Coding">
                            <h4>Consultancy</h4>
                    ...
                    @for ($x = 1 ; $x <= 6 ; $x++)
                        <div class="col-md-4 col-xs-6">
                            <div class="portfolio-item">
                                <img src="{{asset('assets/mypage/img/portfolio-'.$x.'.jpg')}}" class="img-res" alt="">
                                <div class="portfolio-item-info">
                                    <h4>Project Title</h4>
                                    <a href="#" data-toggle="modal" data-target="{{'#portfolioItem'.$x}}"><span
        ...
        <section id="contact" class="site-section section-form text-center">
            <div class="container">
                ...
                <form>
                    <div class="row">
                        <div class="col-sm-6">
                            <input type="text" name="name" class="form-control mt-x-0" placeholder="Name"
                                required>
                        </div>
                        <div class="col-sm-6">
    ...
    @for ($x = 1 ; $x <= 6 ; $x++)
        <div id="{{'portfolioItem'.$x}}" class="modal fade" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <a class="close" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span></a>
                        <img class="img-res" src="{{asset ('assets/mypage/img/portfolio-'.$x.'.jpg')}}" alt="">
                    </div>
                    <div class="modal-body">
                        <h4 class="modal-title">Project title</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec commodo finibus tristique.
                            Maecenas dignissim condimentum sem eu tincidunt. Curabitur in dui quis magna vestibulum pulvinar
                            a ut urna. Nam pellentesque mattis urna. Aenean eget lectus sit amet turpis facilisis
                            consectetur quis vel ante. Integer in massa ut nibh ultricies sagittis imperdiet in ante. Nam
                            sed turpis vel ante placerat feugiat ac tempus magna. Nam aliquet ullamcorper dolor non
                            hendrerit.</p>
                    </div>
    ...
    <script src="{{ asset('assets/mypage/js/bootstrap.min.js') }}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.4.1/jquery.easing.min.js"></script>
    <script src="{{ asset('assets/mypage/js/skrollr.min.js') }}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-progressbar/0.9.0/bootstrap-progressbar.min.js"></script>
    <script src="{{ asset('assets/mypage/js/jquery.countTo.min.js') }}"></script>
    <script src="{{ asset('assets/mypage/js/script.js') }}"></script>
